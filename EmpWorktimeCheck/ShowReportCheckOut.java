...
public class ShowReportCheckOut extends JFrame {
  // start attributes
  ...
  private JLabel lReportCheckOut1 = new JLabel();
  // end attributes

  public ShowReportCheckOut() { 
    // Frame-Init
    super();
    ...
    cp.add(bRefresh1);
    lReportCheckOut1.setBounds(224, 24, 242, 37);
    lReportCheckOut1.setText("Report Check Out");
    lReportCheckOut1.setFont(new Font("Dialog", Font.BOLD, 28));
    cp.add(lReportCheckOut1);
    // end components
    setVisible(true);
  ...
  public void Empshowdata(){
    try {
      ...
      ResultSet rs = st.executeQuery("SELECT e1.YOURID,e2.NAME, e2.LASTNAME,e1.CHECKEMP ,e1.TIME,e1.DATE FROM emptimecheckout e1 JOIN employee e2 ON e1.YOURID = e2.YOURID;");
  ...
  public void searchByID(){
    try {
      ...
      String sqlQuery = "SELECT e1.YOURID, e2.NAME, e2.LASTNAME, e1.CHECKEMP, e1.TIME ,e1.DATE FROM emptimecheckout e1 JOIN employee e2 ON e1.YOURID = e2.YOURID WHERE e1.YOURID =?;";
